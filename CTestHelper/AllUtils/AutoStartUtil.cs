...
*命名空间：CTestHelper.AllUtils
*文件名： AutoStartUtil
*创建人： 王华斌
*创建时间：2020/5/5 11:33:35
*描述：将本程序设为开机自动启动
*=======================================================================
*修改标记
*修改时间：2020/5/5 11:33:35
*修改人：XXX
*描述：
************************************************************************/
using System;
...
namespace CTestHelper.AllUtils
{
    class AutoStartUtil
    {
        /// <summary>
        /// 快捷方式名称-任意自定义
        /// </summary>
        private const string QuickName = "CTestHelper";
        ...
        public void SetMeAutoStart(bool onOff = true)
        {
            if (onOff)//开机启动
            {
                ...
                {
                    CreateShortcut(systemStartPath, QuickName, appAllPath, "中钢实验室助手");
                }
            }
            else//开机不启动
            {
